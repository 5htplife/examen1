...
with st.echo(code_location="below"):
    ...
    def food_obesity_death(df):
        ...
        high_deaths = alt.Chart(df2).mark_bar().encode(x=alt.X('per cent of daily intake', scale=alt.Scale(domain=[0,25])),
                                                                               y='type of food'
    ...
    st.write("The general pattern remains the same: in the least obesed countries people consume much more cereals, starchy roots (both are healthy, complex carbs) and slightly more vegetables, while consuming much less of other types of food compared to the most obesed countries.")
